...
class _$ProfileModelCopyWithImpl<$Res, $Val extends ProfileModel>
  ...
  @override
  $Res call({Object? id = null, Object? role = freezed}) {
    return _then(
      _value.copyWith(
            id: null == id
                ? _value.id
...
class _$ProfileModelImpl extends _ProfileModel {
  const _$ProfileModelImpl({required this.id, this.role}) : super._();
  ...
  @override
  String toString() {
    return 'ProfileModel(id: $id, role: $role)';
  }
...
abstract class _ProfileModel extends ProfileModel {
  const factory _ProfileModel({required final String id, final String? role}) =
      _$ProfileModelImpl;
